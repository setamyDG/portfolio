  ...
  <div className={classes.MirrorContainer}>
    <div className={classes.MirrorTopContainer}>
      ...
      <div className={classes.ButtonContainer}>
        <NavigationItem className={classes.ButtonLink} title='READ MORE' to='AboutMe'></NavigationItem>
      </div>
    </div>
    <div className={classes.MirrorBottomContainer}>
      <div className={classes.MirrorBottomContainerLeft}>
        ...
        <div className={classes.ButtonContainer}>
          <NavigationItem className={classes.ButtonLink} title='READ MORE' to='Portfolio'></NavigationItem>
        </div>
      </div>
